			...
			<div class="dy-add-detail-attr-div">
				...
				<div class="info"
					...
					<div class="item" :style='{ "border": "0px solid #dfdfdf", "padding": "0px 10px", "boxShadow": "0px 2px 0px #eee", "margin": "0 0 8px 0", "borderRadius": "0px", "background": "none", "display": "flex", "justifyContent": "spaceBetween" }'>
						...
						<div v-if="detail.tupian" :style='{ "width": "498px", "padding": "8px 10px 0", "fontSize": "14px", "lineHeight": "24px", "color": "#666", "height": "auto" }'>
							<img :src="baseUrl + detail.tupian" style="margin-right:20px;" width="600" height="400">
							<el-button class="el-icon-download" type="text" @click="download(detail.tupian)">下载</el-button>
						</div>
						<div v-else>暂无图片</div>
					</div>
					<div class="item" :style='{ "border": "0px solid #dfdfdf", "padding": "0px 10px", "boxShadow": "0px 2px 0px #eee", "margin": "0 0 8px 0", "borderRadius": "0px", "background": "none", "display": "flex", "justifyContent": "spaceBetween" }'>
...
export default {
	...
	methods: {
		...
		init() {
			...
			this.$http.get('gonggao/detail/' + this.id, {}).then(res => {
				if (res.data.code == 0) {
