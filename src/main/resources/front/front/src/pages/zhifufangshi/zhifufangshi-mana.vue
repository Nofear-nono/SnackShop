	...
	<div>
		<div class="breadcrumb-preview dy-breadcrumb-div">
			<el-breadcrumb :separator="'Ξ'"
				...
				<el-breadcrumb-item>支付方式列表</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		...
		<div class="list-preview"
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv dy-list-form">
				<el-form-item v-if="!isQuery.mingcheng" :style='{ "margin": "0 10px" }'>
					...
					<el-input suffix-icon="el-icon-search" v-model="formSearch.mingcheng" placeholder="支付方式" clearable></el-input>
				</el-form-item>
...
export default {
	...
	methods: {
		...
		getList() {
			...
			this.$http.get('zhifufangshi/manaqian', { params: Object.assign(params, searchWhere) }).then(res => {
				if (res.data.code == 0) {
