			...
			<div class="dy-add-detail-attr-div">
				...
				<div class="info"
					...
					<div class="btn"
						...
						<el-button type="primary" class="dy-add-button" @click="toZhifufangshiDingdanAdd">订单添加</el-button>
						<el-button type="success" class="dy-chakan-button" @click="toZhifufangshiDingdanChakan">订单查看</el-button>
...
export default {
	...
	methods: {
		...
		init() {
			...
			this.$http.get('zhifufangshi/detail/' + this.id, {}).then(res => {
				if (res.data.code == 0) {
        ...
        //跳转到支付方式订单添加页面
		toZhifufangshiDingdanAdd() {
			this.$router.push({ path: '/index/zhifufangshiDingdanAdd', query: { id: this.id, mingcheng: this.detail.mingcheng } });
		},
		//跳转到支付方式订单查看页面
		toZhifufangshiDingdanChakan() {
			this.$router.push({ path: '/index/dingdanMana', query: { zhifufangshiid: this.id}});
		},
