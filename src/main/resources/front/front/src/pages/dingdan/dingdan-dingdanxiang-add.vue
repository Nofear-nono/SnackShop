  ...
  <div>
    <div class="breadcrumb-preview dy-breadcrumb-div">
      <el-breadcrumb :separator="'Ξ'"
        ...
        <el-breadcrumb-item>订单订单项添加</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
  ...
  methods: {
    ...
    init() {
      if (this.$route.query.id) {
        this.ruleForm.dingdanid = this.$route.query.id;
      }
      if (this.$route.query.mingcheng) {
        this.dingdanbianhao = this.$route.query.mingcheng;
      }
