        ...
        <!-- <el-row class="ad" style="justify-content:flex-start;">
          <el-form-item>
            <el-button :disabled="dataListSelections.length <= 0" type="danger" icon="el-icon-delete"
              @click="shoucangDeleteHandler">批量删除</el-button>
          </el-form-item>
        </el-row> -->
      </el-form>
      <!--数据列表区域-->
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="350" :align="contents.tableAlign" header-align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="success" icon="el-icon-info" size="mini" @click="shoucangDetailHandler(scope.row.id)">详情</el-button>
              <!-- <el-button type="primary" icon="el-icon-edit" size="mini" @click="shoucangSetHandler(scope.row.id)">修改</el-button> -->
              <!-- <el-button type="danger" icon="el-icon-delete" size="mini" @click="shoucangDeleteHandler(scope.row.id)">删除</el-button> -->
