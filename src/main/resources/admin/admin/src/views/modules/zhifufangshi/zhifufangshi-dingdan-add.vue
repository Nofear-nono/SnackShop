<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="input" label="订单支付方式">
            <el-select v-model="zhifufangshimingcheng" disabled>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.zhifufangshiid = id;
      }
      if (mingcheng) {
        this.ruleForm.zhifufangshimingcheng = mingcheng;
      }
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.zhifufangshiDingdanAddFlag = false;
