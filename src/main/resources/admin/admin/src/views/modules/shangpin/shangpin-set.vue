      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" label="名称" prop="mingcheng">
            <el-input v-model="ruleForm.mingcheng" placeholder="名称" clearable
              :readonly="ro.mingcheng"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="编号" prop="bianhao">
            <el-input v-model="ruleForm.bianhao" placeholder="编号" clearable
              :readonly="ro.bianhao"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="分类" prop="pinleiid">
            <el-select v-model="ruleForm.pinleiid" :readonly="ro.zhongleiid" placeholder="请选择分类">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="内容介绍" prop="neirong">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="内容介绍"
              v-model="ruleForm.neirong" :readonly="ro.neirong">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="图片" prop="image">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="原价" prop="yuanshijiage">
            <el-input v-model="ruleForm.yuanshijiage" placeholder="原价" clearable
              :readonly="ro.yuanshijiage"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="现价" prop="jiage">
            <el-input v-model="ruleForm.jiage" placeholder="现价" clearable
              :readonly="ro.jiage"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="单位" prop="danwei">
            <el-input v-model="ruleForm.danwei" placeholder="单位" clearable
              :readonly="ro.danwei"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="是否特价" prop="shenhe">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="库存数量" prop="kucunshuliang">
            <el-input v-model="ruleForm.kucunshuliang" placeholder="库存数量" clearable
              :readonly="ro.kucunshuliang"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="销售数量" prop="xiaoshoushuliang">
            <el-input v-model="ruleForm.xiaoshoushuliang" placeholder="销售数量" clearable
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        pinleiid: [{ required: true, message: '分类不能为空', trigger: 'blur' }, { validator: validateIntNumber, trigger: 'blur' },],
        neirong: [],
