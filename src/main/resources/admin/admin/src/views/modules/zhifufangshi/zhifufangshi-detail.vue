<template>
  <div v-if="this.parent.zhifufangshiDetailFlag" class="addEdit-block">
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.zhifufangshiSetFlag = false;
      this.parent.zhifufangshiDetailFlag = false;
      this.parent.zhifufangshiDingdanChakanFlag = false;
    ...
    dingdanChakanHandler() {
      ...
      this.parent.zhifufangshiDetailFlag = false;
      this.parent.zhifufangshiDingdanChakanFlag = true;
      this.$nextTick(() => {
        this.parent.$refs.zhifufangshiDingdanChakan.init(this.id);
      });
    },
    ...
    dingdanAddHandler() {
      this.parent.showFlag = false;
      this.parent.zhifufangshiDetailFlag = false;
      this.parent.zhifufangshiDingdanAddFlag = true;
      this.$nextTick(() => {
