<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="input" label="售后申请用户">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="说明" prop="neirong">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="说明"
        ...
        <el-col :span="12">
          <el-form-item class="input" label="是否审核" prop="shenhe">
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersShenqingAddFlag = false;
        this.parent.contentStyleChange();
      } else {
        this.$router.replace('/shenqingmana')
      }
    },
