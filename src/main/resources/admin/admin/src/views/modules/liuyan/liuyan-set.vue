      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" label="标题" prop="biaoti">
            <el-input v-model="ruleForm.biaoti" placeholder="标题" clearable
              :readonly="ro.biaoti"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="内容" prop="neirong">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="内容"
              v-model="ruleForm.neirong" :readonly="ro.neirong">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="留言添加时间" prop="addshijian">
            <el-date-picker v-model="ruleForm.addshijian" type="datetime" format="yyyy-MM-dd HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss" placeholder="留言添加时间" default-time="12:00:00" :readonly="ro.addshijian">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="回复" prop="huifu">
            <el-input v-model="ruleForm.huifu" placeholder="回复" clearable
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        biaoti: '',
        neirong: '',
        addshijian: this.getCurrentTime(1),
      ...
      rules: {
        ...
        neirong: [],
        addshijian: [{ required: true, message: '留言添加时间不能为空', trigger: 'blur' },],
