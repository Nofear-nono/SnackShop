      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" label="用户名称" prop="loginname">
            <el-input v-model="ruleForm.loginname" placeholder="用户名称" clearable
              :readonly="ro.loginname"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="密码" prop="loginpw">
            <el-input v-model="ruleForm.loginpw" placeholder="密码" clearable
        ...
        <el-col :span="12">
          <el-form-item class="input" label="性别" prop="xingbie">
            <el-select v-model="ruleForm.xingbie" placeholder="请选择性别" :readonly="ro.xingbie">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="年龄" prop="nianling">
            <el-input v-model="ruleForm.nianling" placeholder="年龄" clearable
