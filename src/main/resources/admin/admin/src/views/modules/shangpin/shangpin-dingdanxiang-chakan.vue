          ...
          <el-table-column width="350" :align="contents.tableAlign" header-align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="primary"
                ...
                @click="shangpinPingjiaAddHandler(scope.row.shangpinid,scope.row.shangpin.mingcheng)">添加评论</el-button>
              </el-tooltip>
...
<script>
import ShangpinPingjiaAdd from "../shangpin/shangpin-pingjia-add"
...
export default {
  ...
  methods: {
    ...
    shangpinPingjiaAddHandler(id,mingcheng) {
      this.showFlag = false;
