<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="input" label="零食分类">
            <el-select v-model="pinleimingcheng" disabled>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.pinleiid = id;
      }
      if (mingcheng) {
        this.pinleimingcheng = mingcheng;
      }
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.pinleiShangpinAddFlag = false;
