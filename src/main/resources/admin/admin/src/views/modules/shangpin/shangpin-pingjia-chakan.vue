    ...
    <div v-if="showFlag">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content" v-if="false">
        <el-row :gutter="20" class="slt" style="justify-content:flex-start;">
          <el-form-item>
            <el-input suffix-icon="el-icon-search" v-model="searchForm.biaoti" placeholder="评语" clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-input suffix-icon="el-icon-search" v-model="searchForm.fenshu" placeholder="分数（范围1-5）" clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <!-- <el-row class="ad" style="justify-content:flex-start;">
          <el-form-item>
            <el-button :disabled="dataListSelections.length <= 0" type="danger" icon="el-icon-delete"
              @click="pingjiaDeleteHandler">批量删除</el-button>
          </el-form-item>
        </el-row> -->
      </el-form>
      <!--数据列表区域-->
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center" label="评语">
            <template slot-scope="scope">
              {{ scope.row.biaoti }}
            </template>
          </el-table-column>
          <el-table-column :align="contents.tableAlign" header-align="center" label="分数（范围1-5）">
            <template slot-scope="scope">
              <!-- {{ scope.row.fenshu }} -->
          ...
          <el-table-column width="350" :align="contents.tableAlign" header-align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="success" icon="el-icon-info" size="mini" @click="pingjiaDetailHandler(scope.row.id)">详情</el-button>
              <!-- <el-button type="primary" icon="el-icon-edit" size="mini" @click="pingjiaSetHandler(scope.row.id)">修改</el-button> -->
              <!-- <el-button type="danger" icon="el-icon-delete" size="mini" @click="pingjiaDeleteHandler(scope.row.id)">删除</el-button> -->
