<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" label="支付方式" prop="mingcheng">
            <el-input v-model="ruleForm.mingcheng" placeholder="支付方式" clearable
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.$router.replace('/zhifufangshimana')
      }
    },
