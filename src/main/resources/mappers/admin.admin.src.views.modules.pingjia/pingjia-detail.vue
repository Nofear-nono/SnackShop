  ...
  <div v-if="this.parent.pingjiaDetailFlag" class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="100px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" label="零食:">
