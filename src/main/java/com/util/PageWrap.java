...
public class PageWrap<M> {
    ...
    private List<com.util.PageWrap.SortData> sorts;

    /**
     * 处理异常排序对象
     */
    public List<com.util.PageWrap.SortData> getSorts () {
        List<com.util.PageWrap.SortData> sorts = new ArrayList<>();
        if (this.sorts == null) {
            return sorts;
        }
        for (com.util.PageWrap.SortData sort: this.sorts) {
    ...
    public void setSorts(List<com.util.PageWrap.SortData> sorts) {
        this.sorts = sorts;
    }
    ...
    public String getOrderByClause () {
        List<com.util.PageWrap.SortData> sorts = this.getSorts();
        if (sorts.size() == 0) {
            return null;
        }
        StringBuilder stringBuilder = new StringBuilder();
        for (com.util.PageWrap.SortData sortData: sorts) {
