...
public class ExampleBuilder<E, C> {
     ...
     * 创建ExampleBuilder对象
     */
    public static <E, C> com.util.ExampleBuilder<E, C> create(Class<E> exampleClass, Class<C> criteriaClass) {
        return new com.util.ExampleBuilder<>(exampleClass, criteriaClass);
    }

    /**
     * 构建Example包装类
     */
    public com.util.ExampleBuilder.ExamplePack<E, C> buildExamplePack(Object model) {
     ...
     * 构建Example包装类
     */
    public com.util.ExampleBuilder.ExamplePack<E, C> buildExamplePack(Object model, Boolean isStrLike) {
        try {
            ...
            if (model == null) {
                return new com.util.ExampleBuilder.ExamplePack<>(example, (C) criteria);
            }
