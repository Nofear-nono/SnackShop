...
public class PageData<T> implements Serializable {
    ...
    public static <T> com.util.PageData<T> from(PageInfo<T> pageInfo) {
        com.util.PageData<T> pageData = new com.util.PageData<>(pageInfo.getPageNum(), pageInfo.getPageSize());
