...
public interface PinleiMapper {
    ...
    //插入分类表pinlei的实体数据（包含null值）
    int insert(Pinlei record);

    //插入分类表pinlei的实体数据（不包含null值）
