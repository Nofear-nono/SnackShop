...
public interface ZhifufangshiMapper {
    ...
    //插入支付方式表zhifufangshi的实体数据（包含null值）
    int insert(Zhifufangshi record);

    //插入支付方式表zhifufangshi的实体数据（不包含null值）
