<template>
  <div v-if="this.parent.liuyanDetailFlag" class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="100px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" label="留言添加时间:">
            <el-input v-model="ruleForm.addshijian" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="回复:">
