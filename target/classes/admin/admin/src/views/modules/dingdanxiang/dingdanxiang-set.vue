<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" label="订单" prop="dingdanid">
            <el-select v-model="ruleForm.dingdanid" :readonly="ro.zhongleiid" placeholder="请选择订单">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="商品数量" prop="goumaishuliang">
            <el-input v-model="ruleForm.goumaishuliang" placeholder="商品数量" clearable
