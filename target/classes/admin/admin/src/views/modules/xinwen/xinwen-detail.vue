        ...
        <el-col :span="12">
          <el-form-item class="input" label="图片:">
            <div v-if="ruleForm.tupian">
              <img :src="getFileSrc(ruleForm.tupian)" style="margin-right:20px;" width="600" height="400">
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.xinwenSetFlag = false;
      this.parent.xinwenDetailFlag = false;
