  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" label="订单金额" prop="jine">
            <el-input v-model="ruleForm.jine" placeholder="订单金额" clearable
              :readonly="ro.jine"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="是否支付" prop="zhifushenhe">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="是否发货" prop="fahuoshenhe">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="是否收货" prop="shouhuoshenhe">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="支付方式" prop="zhifufangshiid">
            <el-select v-model="ruleForm.zhifufangshiid" :readonly="ro.zhongleiid" placeholder="请选择支付方式">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="姓名" prop="xingming">
            <el-input v-model="ruleForm.xingming" placeholder="姓名" clearable
              :readonly="ro.xingming"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="电话" prop="dianhua">
            <el-input v-model="ruleForm.dianhua" placeholder="电话" clearable
              :readonly="ro.dianhua"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="送货地址" prop="dizhi">
            <el-input v-model="ruleForm.dizhi" placeholder="送货地址" clearable
        ...
        <el-col :span="12">
          <el-form-item class="input" label="物流信息" prop="wuliu">
            <el-input v-model="ruleForm.wuliu" placeholder="物流信息" clearable
              :readonly="ro.wuliu"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="备注" prop="beizhu">
            <el-input v-model="ruleForm.beizhu" placeholder="备注" clearable
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        zhifufangshiid: [{ required: true, message: '支付方式不能为空', trigger: 'blur' }, { validator: validateIntNumber, trigger: 'blur' },],
        ...
        wuliu: [{ required: true, message: '物流信息不能为空', trigger: 'blur' },],
