      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="350" :align="contents.tableAlign" header-align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              <el-button v-if="scope.row.zhifushenhe == 'no'" type="primary" icon="el-icon-edit-outline" size="mini" @click="dingdanSet(scope.row.id,'确认支付','zhifushenhe','yes')">确认支付</el-button>
              <el-button v-if="scope.row.shouhuoshenhe == 'no'" type="primary" icon="el-icon-edit-outline" size="mini" @click="dingdanSet(scope.row.id,'确认收货','shouhuoshenhe','yes')">确认收货</el-button>
