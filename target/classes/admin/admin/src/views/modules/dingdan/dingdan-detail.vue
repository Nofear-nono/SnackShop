<template>
  <div v-if="this.parent.dingdanDetailFlag" class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="100px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" label="订单金额:">
            <el-input v-model="ruleForm.jine" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="是否支付:">
            <el-input v-model="ruleForm.zhifushenhe" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="是否发货:">
            <el-input v-model="ruleForm.fahuoshenhe" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="是否收货:">
            <el-input v-model="ruleForm.shouhuoshenhe" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="支付方式:">
            <el-input v-if="ruleForm.zhifufangshi && ruleForm.zhifufangshi.mingcheng" v-model="ruleForm.zhifufangshi.mingcheng" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="送货地址:">
            <el-input v-model="ruleForm.dizhi" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="时间:">
            <el-input v-model="ruleForm.shijian" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" label="物流信息:">
            <el-input v-model="ruleForm.wuliu" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" label="用户:">
