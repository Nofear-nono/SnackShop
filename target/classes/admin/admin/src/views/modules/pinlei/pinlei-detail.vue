<template>
  <div v-if="this.parent.pinleiDetailFlag" class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="100px"
      ...
      <el-form-item class="btn">
        <!-- <el-button class="btn-success" @click="shangpinAddHandler">零食添加</el-button> -->
        <!-- <el-button class="btn-success" @click="shangpinChakanHandler">零食查看</el-button> -->
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.pinleiSetFlag = false;
      this.parent.pinleiDetailFlag = false;
      this.parent.pinleiShangpinChakanFlag = false;
    ...
    shangpinChakanHandler() {
      ...
      this.parent.pinleiDetailFlag = false;
      this.parent.pinleiShangpinChakanFlag = true;
      this.$nextTick(() => {
        this.parent.$refs.pinleiShangpinChakan.init(this.id);
      });
    },
    ...
    shangpinAddHandler() {
      this.parent.showFlag = false;
      this.parent.pinleiDetailFlag = false;
      this.parent.pinleiShangpinAddFlag = true;
      this.$nextTick(() => {
        this.parent.$refs.pinleiShangpinAdd.init(this.id, this.ruleForm.mingcheng);
      });
    },
