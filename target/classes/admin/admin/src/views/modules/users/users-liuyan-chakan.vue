    ...
    <div v-if="showFlag">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content" v-if="false">
        <el-row :gutter="20" class="slt" style="justify-content:flex-start;">
          ...
          <el-form-item>
            <el-input suffix-icon="el-icon-search" v-model="searchForm.huifu" placeholder="回复" clearable></el-input>
          </el-form-item>
        ...
        <!-- <el-row class="ad" style="justify-content:flex-start;">
          <el-form-item>
            <el-button :disabled="dataListSelections.length <= 0" type="danger" icon="el-icon-delete"
              @click="liuyanDeleteHandler">批量删除</el-button>
          </el-form-item>
        </el-row> -->
      </el-form>
      <!--数据列表区域-->
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center" label="留言添加时间">
            <template slot-scope="scope">
          ...
          <el-table-column :align="contents.tableAlign" header-align="center" label="回复">
            <template slot-scope="scope">
              {{ scope.row.huifu }}
            </template>
          </el-table-column>
          ...
          <el-table-column width="350" :align="contents.tableAlign" header-align="center" label="操作" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="success" icon="el-icon-info" size="mini" @click="liuyanDetailHandler(scope.row.id)">详情</el-button>
              <!-- <el-button type="primary" icon="el-icon-edit" size="mini" @click="liuyanSetHandler(scope.row.id)">回复</el-button> -->
              <!-- <el-button type="danger" icon="el-icon-delete" size="mini" @click="liuyanDeleteHandler(scope.row.id)">删除</el-button> -->
