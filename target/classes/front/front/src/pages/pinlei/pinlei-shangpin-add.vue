  ...
  <div>
    <div class="breadcrumb-preview dy-breadcrumb-div">
      <el-breadcrumb :separator="'Ξ'"
        ...
        <el-breadcrumb-item>分类零食添加</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
  ...
  methods: {
    ...
    init() {
      if (this.$route.query.id) {
        this.ruleForm.pinleiid = this.$route.query.id;
      }
      if (this.$route.query.mingcheng) {
        this.pinleimingcheng = this.$route.query.mingcheng;
      }
